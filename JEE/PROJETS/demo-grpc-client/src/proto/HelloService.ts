...
/**
 * @generated from protobuf message fr.formation.demogrpcserver.proto.HelloRequest
 */
...
/**
 * @generated from protobuf message fr.formation.demogrpcserver.proto.HelloResponse
 */
...
class HelloRequest$Type extends MessageType<HelloRequest> {
    constructor() {
        super("fr.formation.demogrpcserver.proto.HelloRequest", [
...
/**
 * @generated MessageType for protobuf message fr.formation.demogrpcserver.proto.HelloRequest
 */
export const HelloRequest = new HelloRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class HelloResponse$Type extends MessageType<HelloResponse> {
    constructor() {
        super("fr.formation.demogrpcserver.proto.HelloResponse", [
...
/**
 * @generated MessageType for protobuf message fr.formation.demogrpcserver.proto.HelloResponse
 */
export const HelloResponse = new HelloResponse$Type();
/**
 * @generated ServiceType for protobuf service fr.formation.demogrpcserver.proto.HelloService
 */
export const HelloService = new ServiceType("fr.formation.demogrpcserver.proto.HelloService", [
    { name: "hello", serverStreaming: true, options: {}, I: HelloRequest, O: HelloResponse }
]);
